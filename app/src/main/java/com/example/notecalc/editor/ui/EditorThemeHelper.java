...
public class EditorThemeHelper {
    public static void applyEditorTheme(MainActivity activity, View formContainer, View tableHeader, EditText editDesc, EditText editAmount, TextView btnDate, TextView btnCancelEdit, TextView btnAdd) {
        // Title box removed; it is now a plain TextView without a background
